    ...
    <form role="form" method="post" action="{{route('dashboard.products.update',$product)}}"
        ...
        <div class="box-body">
            @foreach(LaravelLocalization::getSupportedLanguagesKeys() as $locale)
                ...
                <div class="form-group">
                    ...
                    <textarea name="description[{{$locale}}]" type="text" class="form-control" id="description" required
                              placeholder="@lang('fields.'.$locale.'.description')">{{ old('description.'.$locale,$product->description[$locale]) }}</textarea>
                </div>
            @endforeach
            ...
            <div class="form-group">
                ...
                <img id="imagePreview" src="{{$product->image_path}}" alt="Image Preview" height="50"
            ...
            <div class="form-group">
                ...
                <input name="purchase_price" type="number" step="0.5" min="1" class="form-control" id="purchase_price"
                       ...
                       placeholder="@lang('fields.purchase_price')">
            </div>
            ...
            <div class="form-group">
                ...
                <input name="sell_price" type="number" step="0.5" min="1" class="form-control" id="sell_price" required
                       value="{{ old('sell_price',$product->sell_price) }}" placeholder="@lang('fields.sell_price')">
            </div>

            <div class="form-group">
                <label for="stock">@lang('fields.stock')</label>
                <input name="stock" type="number" step="1" class="form-control" id="stock" required
                       value="{{ old('stock',$product->stock) }}" placeholder="@lang('fields.stock')">
            </div>

            <div class="form-group">
                <label for="category_id">@lang('fields.category')</label>
                <x-categories.dropdown :name="'category_id'"
                                       :selected="old('category_id',$product->category_id)"></x-categories.dropdown>
            </div>
